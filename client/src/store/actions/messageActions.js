...
//     const response = await axios.get('https://localhost:4000/api/messages');
...
//   try {
//     const options = attachTokenToHeaders(getState);
//     const response = await axios.post('https://localhost:4000/api/messages', formData, options);
...
//   try {
//     const options = attachTokenToHeaders(getState);
//     const response = await axios.delete(`https://localhost:4000/api/messages/${id}`, options);
...
//   try {
//     const options = attachTokenToHeaders(getState);
//     const response = await axios.put(`http::/localhost:4000/api/messages/${id}`, formData, options);
